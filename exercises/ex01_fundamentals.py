...
def _():
    ...
    favorite_foods = ["Rice", "Yam", "Goat Meat", "Pasta", "Pizza"]  # Add your foods here
...
def _():
    ...
    # - title: book title (My Dreams)
    # - author: author name (David Blink)
    # - year: publication year (2008)
    # - pages: number of pages (300)
...
def _():
    ...
    squares: list[int] = [x**2 for x in range(1, 11)]  # Use list comprehension here
...
def _():
    ...
    even_numbers: list[int] = [x for x in all_numbers if x % 2 == 0]  # Use list comprehension here
